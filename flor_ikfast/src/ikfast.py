...
class IKFastSolver(AutoReloader):
    ...
    def numpyMatrixToSympy(self,T):
        if axisAngleFromRotationMatrix is not None:
            ...
            if (0==angle): # add protection
                print "numpyMatrixToSympy - zero angle - set to arbitrary axis"
                #print "T=",T
                #print "axisangle=",axisangle
                #print "angle=",angle
                axisangle[0] = 1.0 # Arbitrary axis
                #print "axisangle=",axisangle
            else:
                axisangle /= angle
            #print 'rotation angle: %f, axis=[%f,%f,%f]' % ((angle*180/pi).evalf(),axisangle[0],axisangle[1],axisangle[2],),
